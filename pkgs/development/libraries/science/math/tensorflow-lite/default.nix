...
stdenv.mkDerivation rec {
  ...
  buildPhase = ''
    ...
    ln -s ${cpuinfo-src} ./cpuinfo
    ln -s ${fp16-src} ./fp16
    ln -s ${tflite-eigen} ./eigen
    ...
    includes="\
      ...
      -I $PWD/tensorflow/lite/tools/make/downloads/ruy \
      -I $PWD/tensorflow/lite/tools/make/downloads/cpuinfo \
      -I $PWD/tensorflow/lite/tools/make/downloads/cpuinfo/src \
      -I $PWD/tensorflow/lite/tools/make/downloads/cpuinfo/include \
      -I $PWD/tensorflow/lite/tools/make/downloads/cpuinfo/deps/clog/include \
