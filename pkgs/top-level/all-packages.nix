...
in
{
  ...
  makeWrapper =
    makeSetupHook
      { deps = [ dieHook ]; substitutions = { shell = pkgs.runtimeShell; }; }
  ...
  netsurf = recurseIntoAttrs (
    let callPackage = newScope pkgs.netsurf; in
    rec {
  ...
  inherit (
  callPackage ../tools/networking/miniupnpc { inherit (darwin) cctools; })
  ...
  wstunnel =
    haskell.lib.justStaticExecutables (haskellPackages.callPackage ../tools/networking/wstunnel { });
  ...
  oraclejdk8distro = installjdk: pluginSupport: (if pluginSupport then appendToName "with-plugin" else x: x) (callPackage ../development/compilers/oraclejdk/jdk8-linux.nix {
  ...
  utillinuxMinimal =
    if stdenv.isLinux then appendToName "minimal" (utillinux.override {
      minimal = true;
      ncurses = null;
      perl = null;
      systemd = null;
  ...
  clearlyU =
    callPackage ../data/fonts/clearlyU { inherit (buildPackages.xorg) fonttosfnt mkfontscale; };

  cm_unicode = callPackage ../data/fonts/cm-unicode { };

  creep =
    callPackage ../data/fonts/creep { inherit (buildPackages.xorg) fonttosfnt mkfontscale; };
  ...
  dina-font =
    callPackage ../data/fonts/dina { inherit (buildPackages.xorg) mkfontscale; };
  ...
  envypn-font =
    callPackage ../data/fonts/envypn-font { inherit (buildPackages.xorg) fonttosfnt mkfontscale; };
  ...
  gohufont =
    callPackage ../data/fonts/gohufont { inherit (buildPackages.xorg) fonttosfnt mkfontscale; };
  ...
  profont =
    callPackage ../data/fonts/profont { inherit (buildPackages.xorg) mkfontscale; };
  ...
  siji =
    callPackage ../data/fonts/siji { inherit (buildPackages.xorg) mkfontscale fonttosfnt; };
  ...
  terminus_font =
    callPackage ../data/fonts/terminus-font { inherit (buildPackages.xorg) fonttosfnt mkfontscale; };
  ...
  ucs-fonts =
    callPackage ../data/fonts/ucs-fonts { inherit (buildPackages.xorg) fonttosfnt mkfontscale; };
  ...
  uni-vga =
    callPackage ../data/fonts/uni-vga { inherit (buildPackages.xorg) fonttosfnt mkfontscale; };
  ...
  unifont =
    callPackage ../data/fonts/unifont { inherit (buildPackages.xorg) fonttosfnt mkfontscale; };
  ...
  bitscope =
    recurseIntoAttrs (callPackage ../applications/science/electronics/bitscope/packages.nix { });
  ...
  libreoffice-qt = lowPrio (callPackage ../applications/office/libreoffice/wrapper.nix {
    libreoffice =
      libsForQt5.callPackage ../applications/office/libreoffice
        (libreoffice-args // {
          kdeIntegration = true;
          variant = "fresh";
        });
  ...
  libreoffice-fresh = lowPrio (callPackage ../applications/office/libreoffice/wrapper.nix {
    libreoffice =
      callPackage ../applications/office/libreoffice
        (libreoffice-args // {
          variant = "fresh";
        });
  }
  ...
  wrapKodi = { kodi }: callPackage ../applications/video/kodi/wrapper.nix {
    ...
    plugins = let inherit (lib) optional optionals; in
      ...
      ([ ]
        ...
        ++
        optional
          (config.kodi.enableAdvancedEmulatorLauncher or false)
          advanced-emulator-launcher
        ++
        optionals
          (config.kodi.enableControllers or false)
          (with controllers;
        ...
        ++
        optionals
          (config.kodi.enableHyperLauncher or false)
  ...
  */
  ...
  nixosOptionsDoc = attrs: (import ../../nixos/lib/make-options-doc/default.nix) ({ inherit pkgs lib; } // attrs);
  ...
  tewi-font =
    callPackage ../data/fonts/tewi { inherit (buildPackages.xorg) fonttosfnt mkfontscale; };

  texFunctions = callPackage ../tools/typesetting/tex/nix pkgs;

  # TeX Live; see https://nixos.org/nixpkgs/manual/#sec-language-texlive
  texlive =
    recurseIntoAttrs (callPackage ../tools/typesetting/tex/texlive { });
